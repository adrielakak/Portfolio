...
void main() {
  ...
  // Base background is #111111 (0.066, 0.066, 0.066)
  vec3 baseColor = vec3(0.066, 0.066, 0.066);
...
const uniforms = {
  ...
  enableMouseInteraction: new THREE.Uniform(CONFIG.enableMouseInteraction),
...
const retroEffect = new RetroEffect({ colorNum: CONFIG.colorNum, pixelSize: CONFIG.pixelSize });
